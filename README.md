# genpark-multi-model-unified-prompt-workspace-synchronizer-skill
...
> **GenPark AI Agent Skill** -- Multi-model unified prompt workspace synchronizer & diff matrix (TypingMind style)
